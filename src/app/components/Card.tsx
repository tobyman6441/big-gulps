...
const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ cardId, title, description, tags, assignee, onEdit, onDelete, debug }, ref) => {
    ...
    return (
      <div
        ref={ref}
        data-card-id={cardId}
        className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 w-72 border border-gray-200 dark:border-gray-700 transition-all"
        style={debug ? { outline: '2px solid magenta', position: 'relative', zIndex: 10 } : {}}
      >
